...
class Overview_view:
    def __init__(self):
        ...
        self.button_edit = Button(image=self.button_img_edit, borderwidth=0, highlightthickness=0, activebackground="#55908B", command=lambda: Overview_process.edit_button(self.window) , relief="flat")
