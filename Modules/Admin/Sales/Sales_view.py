...
class Sales_view:
    def __init__(self):
        ...
        self.users = Button(image=self.button_img_users, borderwidth=0, highlightthickness=0, activebackground="#51908D", command=lambda: Overview_process.Overview_process.users_button(self.window), relief="flat")
