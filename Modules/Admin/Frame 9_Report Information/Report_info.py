...
class Report_Information:
    def __init__(self):
        ...
        entry_data = [
            (369.8926, 565.9047, 148.5895, 30.2471),  # Entry 1
            (574.125, 565.9047, 148.5895, 30.2471)  # Entry 2
        ]
        for x, y, w, h in entry_data:
            self.canvas.create_image(x + w / 2, y + h / 2, image=entry_image)
        ...
        # Button 3 (Visualize)
        self.btn_img_3 = PhotoImage(file=self.relative_to_assets("button_visualize.png"))
        ...
        # Button 4 (Search)
        self.btn_img_4 = PhotoImage(file=self.relative_to_assets("button_search.png"))
        ...
        # Button 5 (Sales)
        self.btn_img_5 = PhotoImage(file=self.relative_to_assets("button_sales.png"))
        ...
        # Button 6 (Users)
        self.btn_img_6 = PhotoImage(file=self.relative_to_assets("button_users.png"))
        ...
        # Button 7 (Price)
        self.btn_img_7 = PhotoImage(file=self.relative_to_assets("button_price.png"))
        ...
        # Button 8 (Edit)
        self.btn_img_8 = PhotoImage(file=self.relative_to_assets("button_edit.png"))
        ...
        # Button 9 (Overview)
        self.btn_img_9 = PhotoImage(file=self.relative_to_assets("button_overview.png"))
