...
class Price_view:
    def __init__(self):
        ...
        self.button_sales = Button(image=self.button_img_sales, borderwidth=0, highlightthickness=0, activebackground="#51908D", command=lambda: self.sales_button(self), relief="flat")
        ...
        self.button_users = Button(image=self.button_img_users, borderwidth=0, highlightthickness=0, activebackground="#51908D", command=lambda: self.users_button(self), relief="flat")
        ...
        self.button_edit = Button(image=self.button_img_edit, borderwidth=0, highlightthickness=0, activebackground="#51908D", command=lambda: self.edit_button(self), relief="flat")
        ...
        self.button_overview = Button(image=self.button_img_overview, borderwidth=0, highlightthickness=0, activebackground="#51908D", command=lambda: self.overview_button(self), relief="flat")
        ...
        self.button_update = Button(image=self.button_img_update, borderwidth=0, highlightthickness=0, activebackground="#51908D", command=lambda: print("clicked"), relief="flat")
